...
def insert_thought_with_classifications(classified_thought):
    stored_thought = ThoughtRecord(classified_thought.id, classified_thought.text)
...
def __insert_thought_classifications(classified_thought, inserted_thought_id):
    ...
    thought_classifications = [ThoughtClassificationRecord(inserted_thought_id, int(classification_id)) for classification_id in classified_thought.classification_ids]
